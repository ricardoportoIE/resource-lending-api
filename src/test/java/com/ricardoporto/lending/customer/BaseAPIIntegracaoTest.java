...
import com.ricardoporto.lending.ResourceLendingApplication;
...
@SpringBootTest(
    classes = ResourceLendingApplication.class,
    webEnvironment =
    ...
    Usuario user =
        (Usuario)
            service.loadUserByUsername(
                "admin@email.com"); // note que os testes estão passando com o perfil "admin"
    assertNotNull(user);
